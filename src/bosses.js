...
export function drawBoss0WithPencils(ctx, cx, cy, radius, tick, pencilsAlive) {
    const r = radius;
    ctx.save();
    // Case base
...
export function drawBoss1(ctx, cx, cy, radius, tick) {
    ...
    ctx.beginPath();
    ctx.arc(cx + sway - 8, cy - r * 0.55, 4, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(cx + sway + 8, cy - r * 0.55, 4, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#fff';
    ctx.beginPath();
    ctx.arc(cx + sway - 7, cy - r * 0.56, 2, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(cx + sway + 9, cy - r * 0.56, 2, 0, Math.PI * 2);
    ctx.fill();
    // Arms + gloves
...
export function drawBoss4(ctx, cx, cy, radius, tick) {
    ...
    ctx.fillStyle = '#888';
    ctx.beginPath();
    ctx.arc(cx, cy + r * 0.1, r * 0.12, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#aaa';
    ctx.beginPath();
    ctx.arc(cx, cy + r * 0.1, r * 0.07, 0, Math.PI * 2);
    ctx.fill();
    // Handle rings
    ctx.strokeStyle = '#22cc44';
    ctx.lineWidth = 7;
    ctx.beginPath();
    ctx.arc(cx - r * 0.25, cy + r * 0.5, r * 0.22, 0, Math.PI * 2);
    ctx.stroke();
    ctx.beginPath();
    ctx.arc(cx + r * 0.25, cy + r * 0.5, r * 0.22, 0, Math.PI * 2);
    ctx.stroke();
    ...
    ctx.fillStyle = '#111';
    ctx.beginPath();
    ctx.arc(cx - r * 0.25, cy + r * 0.5, r * 0.055, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(cx + r * 0.25, cy + r * 0.5, r * 0.055, 0, Math.PI * 2);
    ctx.fill();
...
export function drawBoss5(ctx, cx, cy, radius, tick) {
    ...
    ctx.beginPath();
    ctx.arc(cx + r * 0.55, cy - r * 0.22 - stapleAnim, 5, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.arc(cx + r * 0.55, cy - r * 0.22 - stapleAnim, 13, 0, Math.PI * 2);
    ctx.fill();
    // Blue eyes
    ctx.fillStyle = '#88aaff';
    ctx.beginPath();
    ctx.arc(cx - r * 0.2, cy + r * 0.22, r * 0.07, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(cx + r * 0.2, cy + r * 0.22, r * 0.07, 0, Math.PI * 2);
    ctx.fill();
...
export const BOSS_DRAW_FNS = [drawBoss0, drawBoss1, drawBoss2, drawBoss3, drawBoss4, drawBoss5];
